...
public class Actv_Fama extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_actv__fama);
            ...
            public void onClick(View v) {
                ...
                if (nota1.length() == 0 && nota2.length() == 0) {
                    ...
                    AlertDialog.Builder dialogo = new
                            AlertDialog.Builder(Actv_Fama.this);
    ...
    public void instituicao (View view){
        ...
        i.setData(Uri.parse("http://www.faculdadeamadeus.com.br/"));
        startActivity(i);
    }
}
