...
public class Actv_Estacio extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_actv__estacio);
            ...
            public void onClick(View v) {
                ...
                if (nota1.length() == 0 && nota2.length() == 0) {
                    ...
                    AlertDialog.Builder dialogo = new
                            AlertDialog.Builder(Actv_Estacio.this);
    ...
    public void instituicao (View view){
        ...
        Intent i = new Intent(Intent.ACTION_VIEW);
                i.setData(Uri.parse("http://portal.estacio.br/"));
        startActivity(i);
    }
}
