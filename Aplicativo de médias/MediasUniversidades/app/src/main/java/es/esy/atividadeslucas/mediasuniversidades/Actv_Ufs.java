...
public class Actv_Ufs extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_actv__ufs);
            ...
            public void onClick(View v) {
                ...
                if (nota1.length() == 0 && nota2.length() == 0) {
                    ...
                    AlertDialog.Builder dialogo = new
                            AlertDialog.Builder(Actv_Ufs.this);
    ...
    public void instituicao (View view){
        ...
        i.setData(Uri.parse("http://www.ufs.br/"));
        startActivity(i);
    }
