...
public class Actv_Unit extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_actv__unit);
            ...
            public void onClick(View v) {
                ...
                if (nota1.length() == 0 && nota2.length() == 0) {
                    ...
                    AlertDialog.Builder dialogo = new
                            AlertDialog.Builder(Actv_Unit.this);
    ...
    public void instituicao (View view){
        ...
        i.setData(Uri.parse("http://www.unit.br/"));
        startActivity(i);
    }
}
