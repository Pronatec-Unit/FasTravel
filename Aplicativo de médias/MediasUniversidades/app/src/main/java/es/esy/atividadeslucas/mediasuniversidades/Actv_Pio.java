...
public class Actv_Pio extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_actv__pio);
            ...
            public void onClick(View v) {
                ...
                if (nota1.length() == 0 && nota2.length() == 0) {
                    ...
                    AlertDialog.Builder dialogo = new
                            AlertDialog.Builder(Actv_Pio.this);
    ...
    public void instituicao(View view) {
        ...
        i.setData(Uri.parse("http://www.piodecimo.com.br/faculdade"));
        startActivity(i);
    }
}